...
import { findUncoveredRootHtmlEntrypoints } from "./i18n-audit/find-uncovered-root-html-entrypoints.mjs";
...
export function runI18nLiteralAudit(repoRoot) {
  ...
  issues.push(...findUncoveredRootHtmlEntrypoints(repoRoot, targetFiles));
